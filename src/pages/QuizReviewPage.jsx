    ...
    <DashboardLayout>
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center justify-between px-8 pt-6 pb-4">
          <div>
            <h1 className="text-3xl font-bold text-yellow-300 drop-shadow-lg">{quizData.title}</h1>
            <p className="text-white text-sm">Review Jawaban - Skor: {quizData.score}</p>
          </div>
          <button
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mb-5">
                  <input
                    type="text"
                    className="w-full bg-gray-200 text-lg font-semibold px-5 py-3 rounded-lg shadow-md text-center pointer-events-none"
                ...
                <div className="grid grid-cols-2 gap-x-6 gap-y-4 mb-8">
                  {currentQ.options.map((option, i) => {
                    ...
                    return (
                      ...
                      >
                        <div className="bg-transparent w-full font-bold text-base flex items-center justify-between">
                          <span>{option}</span>
                          {isCorrect && <span className="text-green-700 text-2xl ml-2">✓</span>}
                          {isWrong && <span className="text-red-700 text-2xl ml-2">✗</span>}
                        </div>
                        <div
                          className={`absolute top-4 right-4 w-8 h-8 border-2 flex items-center justify-center transition ${
                ...
                <div className="mb-6 flex gap-6 justify-center">
                  <button
                    type="button"
                    className={`px-6 py-2.5 text-base font-bold rounded-lg shadow-md border-2 border-gray-300 transition pointer-events-none ${
