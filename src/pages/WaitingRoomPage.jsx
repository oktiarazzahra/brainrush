...
const WaitingRoomPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-cyan-50 to-sky-50 p-6">
      <div className="max-w-6xl mx-auto">
        
        <motion.div 
          initial={{ y: -20, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          className="bg-white/90 backdrop-blur-md rounded-2xl p-4 mb-6 border border-blue-200 shadow-lg"
        >
          <div className="flex items-center justify-between">
            <button
              onClick={() => navigate('/my-quizzes')}
              className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2.5 rounded-xl transition font-semibold text-sm flex items-center gap-2 shadow-md hover:shadow-lg"
            >
              ← Back
            </button>
          <div className="text-center">
            <h1 className="text-2xl font-bold text-gray-800 mb-1">{quizTitle || quiz?.title}</h1>
            <p className="text-gray-600 text-sm font-medium">{totalQuestions || quiz?.questions?.length || 0} Soal • Brain Rush Live</p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl p-5 shadow-lg border border-blue-200 hover:shadow-xl transition-all duration-300"
            >
            ...
            <motion.div
              ...
              className="bg-white rounded-2xl p-5 shadow-lg border border-blue-200"
            >
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              className="bg-white rounded-2xl p-5 shadow-lg border border-blue-200 min-h-[600px]"
            >
