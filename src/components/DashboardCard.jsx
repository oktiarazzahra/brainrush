...
const DashboardCard = ({
  ...
  <motion.div
    ...
    className={`group cursor-pointer w-full ${isContinue ? 'ring-4 ring-yellow-300 scale-[1.03]' : ''}`}
    style={{ minHeight: 240 }}
  >
    <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300">
      <div className={`h-32 bg-gradient-to-r ${bgColor} flex items-center justify-center overflow-hidden relative`}>
        <img
          src={image}
          alt={title}
